...
replace (
	...
	github.com/denisenkom/go-mssqldb => github.com/easyops-cn/go-mssqldb v1.0.0
	...
	github.com/elastic/elastic-agent-system-metrics => github.com/easyops-cn/elastic-agent-system-metrics v1.0.4
	...
	github.com/vmware/govmomi => github.com/easyops-cn/govmomi v1.0.0
)
